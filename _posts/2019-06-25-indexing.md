...
<p><span itemscope itemtype="http://schema.org/Photograph"><img src="{{ '/assets/images/20190625/20190625140231.png' | relative_url }}" alt="f:id:aoma23:20190625140231p:plain" title="f:id:aoma23:20190625140231p:plain" class="hatena-fotolife" itemprop="image"></span></p>

<p>やはり、、見事にインデクシングされていない。。</p>

<h2>インデクシング登録する</h2>

<p>インデクシングの依頼はGoogle Search Consoleから行うことができます。</p>
...
<p><span itemscope itemtype="http://schema.org/Photograph"><img src="{{ '/assets/images/20190625/20190625141348.png' | relative_url }}" alt="f:id:aoma23:20190625141348p:plain" title="f:id:aoma23:20190625141348p:plain" class="hatena-fotolife" itemprop="image"></span></p>
...
<span itemscope itemtype="http://schema.org/Photograph"><img src="{{ '/assets/images/20190626/20190626153815.png' | relative_url }}" alt="f:id:aoma23:20190626153815p:plain" title="f:id:aoma23:20190626153815p:plain" class="hatena-fotolife" itemprop="image"></span></p>
...
<ul>
<li>Before: ついにGoogleドライブでExcelを直接編集できるようになった！</li>
<li>After: スプレッドシートでExcelファイルをExcelのまま編集できるようになったよ！</li>
</ul>
