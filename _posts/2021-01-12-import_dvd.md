...
<p>自作DVDをGoogleフォトに取り込むことにしたのですが、いろいろ問題があったのでメモしておきます。
結論としてはHandBrakeというアプリでDVDを一度mp4に変換してからGoogleフォトにアップします。</p>

<h2>今後もDVDを取り込む際はHandBrakeに決めた！</h2>

<p>MacでDVDをmp4など扱いやすい拡張子で取り込みたかったのですが、デフォルトアプリでは対応できないようで、仕方なくアプリをインストールすることにしました。
「DVD 取り込み 変換」とか「DVD リッピング Mac」とかで検索するといろいろ胡散臭そうなアプリがヒットするのですが、下記理由でHandBrakeに決めました！
...
<p>あとは待つだけ！簡単！
そして出来上がったファイルをGoogleフォトにドラッグ＆ドロップすればOK！</p>

<h2>おまけ：Googleフォトにvobファイル直接取り込んだら最終的にうまくいかなかった話</h2>
